...
// have destructuring inside my component
    const [ viewfullRecipe, setViewFullRecipe ] = useState(null);
// to access different recipe id's from my route
    const { id } = useParams();
// i need to use useEffect so that this page loads
//  when my routes change  
    useEffect(() => {
        // this is where I will have my working logic
